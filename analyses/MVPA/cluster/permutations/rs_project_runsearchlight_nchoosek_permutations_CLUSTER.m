function rs_project_runsearchlight_nchoosek_permutations_CLUSTER(subNum, condition)
%% MVPA test script
...
Cfg.output_path='/mnt/storage/tier1/anglin/LINANG001QX2/flavio/resting_state_project/mvpa/searchlight/nchoosek_leaveOneRunOut/permutations/';
Cfg.nRuns=9;
...
p=cosmo_nchoosek_partitioner(ds,1,'stimType',[]);%Test in both directions
%Define iterations
niter=100;
% BALANCE PARTITIONS
